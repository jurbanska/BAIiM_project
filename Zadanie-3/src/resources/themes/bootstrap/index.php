...
<html>
    ...
    <head>
        ...
        <title>Wykaz katalogów <?php echo $lister->getListedPath(); ?></title>
    ...
    <body>
        ...
        <div id="page-content" class="container">
            ...
            <div id="directory-list-header">
                <div class="row">
                    <div class="col-md-7 col-sm-6 col-xs-10">Plik</div>
                    <div class="col-md-2 col-sm-2 col-xs-2 text-right">Rozmiar</div>
                    <div class="col-md-3 col-sm-4 hidden-xs text-right">Ostatnio zmodyfikowane</div>
                </div>
            </div>
